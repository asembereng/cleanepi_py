...
class CleaningReport:
    ...
    def add_operation(self, result: OperationResult) -> None:
        ...
        logger.info(
            f"Operation '{result.operation}' completed: "
    ...
    def total_rows_removed(self) -> int:
        ...
        return (
            self.initial_shape[0] - self.final_shape[0]
    ...
    def total_columns_removed(self) -> int:
        ...
        return (
            self.initial_shape[1] - self.final_shape[1]
            if hasattr(self, "final_shape")
            else 0
        )
    ...
    def print_summary(self) -> None:
        ...
        if summary["final_shape"]:
            ...
            print(
                f"  Removed: {summary['total_rows_removed']} rows, "
