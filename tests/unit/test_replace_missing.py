...
class TestReplaceMissingValues:
    ...
    def test_custom_na_strings(self):
        ...
        df = pd.DataFrame(
            {"col1": ["1", "MISSING", "3", "UNKNOWN"], "col2": ["a", "b", "c", "d"]}
        )
    ...
    def test_target_columns(self):
        ...
        df = pd.DataFrame(
            {"process_me": ["1", "-99", "3"], "keep_me": ["a", "-99", "c"]}
        )
    ...
    def test_custom_na_by_column(self):
        ...
        df = pd.DataFrame(
            {"col1": ["1", "MISSING1", "3"], "col2": ["a", "MISSING2", "c"]}
        )

        custom_na = {"col1": ["MISSING1"], "col2": ["MISSING2"]}
    ...
    def test_case_sensitive(self):
        ...
        df = pd.DataFrame(
            {"col1": ["1", "na", "3", "N/A"], "col2": ["a", "null", "c", "NULL"]}
        )
        ...
        assert (
            result_insensitive["col1"].isna().sum()
            >= result_sensitive["col1"].isna().sum()
        )
        assert (
            result_insensitive["col2"].isna().sum()
            >= result_sensitive["col2"].isna().sum()
        )
    ...
    def test_all_missing_values(self):
        ...
        df = pd.DataFrame(
            {"col1": ["-99", "N/A", "NULL"], "col2": ["", "missing", "unknown"]}
        )
    ...
    def test_already_na_values(self):
        ...
        df = pd.DataFrame(
            {"col1": ["1", np.nan, "3", "-99"], "col2": ["a", "b", np.nan, "NULL"]}
        )
    ...
    def test_empty_na_strings(self):
        ...
        df = pd.DataFrame({"col1": ["1", "-99", "3"], "col2": ["a", "NULL", "c"]})
    ...
    def test_numeric_na_values(self):
        ...
        df = pd.DataFrame(
            {"col1": [1, -99, 3, -999], "col2": [1.0, -99.0, 3.0, np.inf]}
        )
