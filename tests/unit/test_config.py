...
class TestDateConfig:
    ...
    def test_invalid_timeframe_format(self):
        ...
        with pytest.raises(
            ValueError, match="timeframe dates must be in YYYY-MM-DD format"
        ):
...
class TestMissingValueConfig:
    ...
    def test_custom_na_by_column(self):
        ...
        custom_na = {"col1": ["na1", "na2"], "col2": ["na3", "na4"]}
...
class TestDuplicateConfig:
    ...
    def test_all_parameters(self):
        """Test all parameters together."""
        config = DuplicateConfig(target_columns=["col1"], subset=["col2"], keep="last")
...
class TestConstantConfig:
    ...
    def test_all_parameters(self):
        """Test all parameters together."""
        config = ConstantConfig(cutoff=0.8, exclude_columns=["important_col"])
...
class TestNumericConfig:
    ...
    def test_all_parameters(self):
        ...
        config = NumericConfig(
            target_columns=["age", "score"], lang="es", errors="ignore"
        )
...
class TestCleaningConfig:
    ...
    def test_global_settings(self):
        ...
        config = CleaningConfig(
            verbose=False, strict_validation=True, max_memory_usage="1GB"
        )
