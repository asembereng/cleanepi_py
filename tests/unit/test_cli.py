...
class TestMainFunction:
    ...
    def test_basic_execution(
        self, mock_setup_logging, mock_load, mock_save, mock_clean
    ):
    ...
    def test_with_config_file(
        ...
        config_dict = {"standardize_column_names": True, "verbose": True}
    ...
    def test_with_cleaning_options(
        self, mock_setup_logging, mock_load, mock_save, mock_clean
    ):
    ...
    @patch(
        "sys.argv",
        ["cleanepi", "input.csv", "--remove-duplicates", "--duplicate-keep", "last"],
    )
    ...
    def test_missing_value_options(
        self, mock_setup_logging, mock_load, mock_save, mock_clean
    ):
        ...
        assert config_used.replace_missing_values.na_strings == [
            "NA",
            "NULL",
            "missing",
        ]
...
def sample_config_file():
    ...
    config = {
        ...
        "verbose": True,
        "replace_missing_values": {"na_strings": ["NA", "NULL", "missing"]},
    }
